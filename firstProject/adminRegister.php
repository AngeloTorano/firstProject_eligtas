...
<center>
    <section id="studentRegistrationForm" style="height: 130vh;">
        <div style="padding-top: 1%; margin-top: 2%; background-color: white; width: 60%; border-radius: 2%;">
            ...
            <h1 style="font-size: larger; color: black;" id="create">CREATE ADMIN ACCOUNT</h1>
            <form id="createAccountForm" action="adminCreateAccount.php" method="POST">
                <div style="width: 60%; padding: 10px;">
                    <div class="input" style="">
                        <input type="hidden" id="adminSrCode" name="srCode" value="<?php echo htmlspecialchars($srCode); ?>" readonly>
